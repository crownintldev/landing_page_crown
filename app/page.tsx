...
import { ChevronLeft, ChevronRight, Phone, Mail, MapPin, Clock, Star, Globe, Shield, Users, Award } from 'lucide-react';

export default function Home() {
  const [currentSlide, setCurrentSlide] = useState(0);

  const authorizedCountries = [
    { name: 'Malaysia', capital: 'Kuala Lumpur', image: 'https://images.pexels.com/photos/1134176/pexels-photo-1134176.jpeg?auto=compress&cs=tinysrgb&w=800' },
    { name: 'Thailand', capital: 'Bangkok', image: 'https://images.pexels.com/photos/1007426/pexels-photo-1007426.jpeg?auto=compress&cs=tinysrgb&w=800' },
    { name: 'Vietnam', capital: 'Hanoi', image: 'https://images.pexels.com/photos/1583339/pexels-photo-1583339.jpeg?auto=compress&cs=tinysrgb&w=800' },
    { name: 'Indonesia', capital: 'Jakarta', image: 'https://images.pexels.com/photos/2507010/pexels-photo-2507010.jpeg?auto=compress&cs=tinysrgb&w=800' },
    { name: 'Iran', capital: 'Tehran', image: 'https://images.pexels.com/photos/3563625/pexels-photo-3563625.jpeg?auto=compress&cs=tinysrgb&w=800' },
    { name: 'Tajikistan', capital: 'Dushanbe', image: 'https://images.pexels.com/photos/3408744/pexels-photo-3408744.jpeg?auto=compress&cs=tinysrgb&w=800' },
    { name: 'Myanmar', capital: 'Naypyidaw', image: 'https://images.pexels.com/photos/3107433/pexels-photo-3107433.jpeg?auto=compress&cs=tinysrgb&w=800' },
    { name: 'Rwanda', capital: 'Kigali', image: 'https://images.pexels.com/photos/5273043/pexels-photo-5273043.jpeg?auto=compress&cs=tinysrgb&w=800' },
    { name: 'Kenya', capital: 'Nairobi', image: 'https://images.pexels.com/photos/259447/pexels-photo-259447.jpeg?auto=compress&cs=tinysrgb&w=800' },
    { name: 'Zimbabwe', capital: 'Harare', image: 'https://images.pexels.com/photos/4353813/pexels-photo-4353813.jpeg?auto=compress&cs=tinysrgb&w=800' },
  ];

  const nextSlide = () => {
    setCurrentSlide((prev) => (prev + 1) % Math.ceil(authorizedCountries.length / 3));
  };

  const prevSlide = () => {
    setCurrentSlide((prev) => (prev - 1 + Math.ceil(authorizedCountries.length / 3)) % Math.ceil(authorizedCountries.length / 3));
  };
    ...
    <main className="min-h-screen">
        ...
        <div className="relative z-10 text-center text-white container-custom animate-fade-in-up">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="heading-primary text-white mb-8 animate-fade-in-up animate-delay-200">
              Pakistan's Best <span className="gradient-text">Recommended</span> Travel Agency
            </h1>
            <p className="text-xl md:text-2xl mb-12 opacity-90 font-light leading-relaxed animate-fade-in-up animate-delay-300">
              Your gateway to the world - Expert visa processing and travel services
            </p>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center animate-fade-in-up">
            <div className="space-y-3 p-6 rounded-2xl glass-effect hover-glow transition-all duration-500 animate-scale-in animate-delay-100">
              <div className="text-5xl font-black text-[var(--color-primary6)] gradient-text">50+</div>
              <div className="text-sm font-semibold text-gray-700 uppercase tracking-wider">Countries Served</div>
            </div>
            <div className="space-y-3 p-6 rounded-2xl glass-effect hover-glow transition-all duration-500 animate-scale-in animate-delay-200">
              <div className="text-5xl font-black text-[var(--color-primary6)] gradient-text">10K+</div>
              <div className="text-sm font-semibold text-gray-700 uppercase tracking-wider">Happy Clients</div>
            </div>
            <div className="space-y-3 p-6 rounded-2xl glass-effect hover-glow transition-all duration-500 animate-scale-in animate-delay-300">
              <div className="text-5xl font-black text-[var(--color-primary6)] gradient-text">98%</div>
              <div className="text-sm font-semibold text-gray-700 uppercase tracking-wider">Success Rate</div>
            </div>
            <div className="space-y-3 p-6 rounded-2xl glass-effect hover-glow transition-all duration-500 animate-scale-in animate-delay-400">
              <div className="text-5xl font-black text-[var(--color-primary6)] gradient-text">15+</div>
        ...
        <div className="container-custom">
          <div className="max-w-5xl mx-auto text-center animate-fade-in-up">
            ...
            <p className="text-primary text-2xl leading-relaxed mb-16 font-light">
              As a full-service Travel Agency, We're specialized in overall Travel Processing. 
              From East Asian escapes to European & American adventures, our expert team handles 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-8 rounded-2xl bg-white shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-100 hover-glow">
                ...
                <h3 className="text-2xl font-bold mb-4 text-[var(--color-primary6)]">Secure & Reliable</h3>
                <p className="text-gray-600 leading-relaxed">Your documents and personal information are handled with utmost security</p>
              </div>
              <div className="text-center p-8 rounded-2xl bg-white shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-200 hover-glow">
                ...
                <h3 className="text-2xl font-bold mb-4 text-[var(--color-primary6)]">Expert Team</h3>
                <p className="text-gray-600 leading-relaxed">Our experienced professionals guide you through every step</p>
              </div>
              <div className="text-center p-8 rounded-2xl bg-white shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-300 hover-glow">
                ...
                <h3 className="text-2xl font-bold mb-4 text-[var(--color-primary6)]">Proven Track Record</h3>
                <p className="text-gray-600 leading-relaxed">Thousands of successful visa applications and happy travelers</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-gradient-to-br from-[var(--color-primary1)]/20 via-[var(--color-primary4)]/10 to-[var(--color-primary7)]/20 relative overflow-hidden">
        ...
        <div className="container-custom">
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="heading-secondary">
              We're Officially <span className="gradient-text">Authorised</span> Visa Application Centre for:
            </h2>
          ...
          <div className="hidden md:block relative animate-fade-in-up animate-delay-200">
            <div className="overflow-hidden rounded-3xl shadow-2xl">
              ...
              >
                {Array.from({ length: Math.ceil(authorizedCountries.length / 3) }, (_, slideIndex) => (
                  <div key={slideIndex} className="w-full flex-shrink-0 grid grid-cols-3 gap-6">
                    {authorizedCountries.slice(slideIndex * 3, slideIndex * 3 + 3).map((country, index) => (
                      <div key={index} className="country-card h-80 group cursor-pointer hover-glow">
                        <img 
                          src={country.image} 
                          alt={country.capital}
                        ...
                        <div className="absolute inset-0 z-20 flex flex-col justify-end p-8">
                          <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                            <h3 className="text-white text-3xl font-bold mb-2 drop-shadow-lg">{country.name}</h3>
                            <p className="text-white/90 text-lg font-medium drop-shadow-md">{country.capital}</p>
                          </div>
                        </div>
          ...
          <div className="md:hidden animate-fade-in-up animate-delay-200">
            <div className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-6 custom-scrollbar">
              {authorizedCountries.map((country, index) => (
                <div key={index} className="country-card group min-w-[300px] h-64 snap-center hover-glow">
                  <img 
                    src={country.image} 
                    alt={country.capital}
                  ...
                  <div className="absolute inset-0 z-20 flex flex-col justify-end p-6">
                    <h3 className="text-white text-2xl font-bold mb-2 drop-shadow-lg">{country.name}</h3>
                    <p className="text-white/90 text-lg font-medium drop-shadow-md">{country.capital}</p>
                  </div>
                </div>
              ))}
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
            <div className="country-card group h-80 cursor-pointer hover-glow animate-fade-in-left animate-delay-200">
              ...
              <div className="absolute inset-0 z-20 flex flex-col justify-end p-8">
                <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                  <h3 className="text-white text-4xl font-bold mb-3 drop-shadow-lg">Singapore</h3>
                  <p className="text-white/90 text-xl font-medium drop-shadow-md">Experience the Lion City</p>
                </div>
              </div>
            ...
            <div className="country-card group h-80 cursor-pointer hover-glow animate-fade-in-right animate-delay-300">
              <img 
                src="https://images.pexels.com/photos/5273043/pexels-photo-5273043.jpeg?auto=compress&cs=tinysrgb&w=800" 
                alt="Uzbekistan"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
              />
              <div className="absolute inset-0 z-20 flex flex-col justify-end p-8">
                <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                  <h3 className="text-white text-4xl font-bold mb-3 drop-shadow-lg">Uzbekistan</h3>
                  <p className="text-white/90 text-xl font-medium drop-shadow-md">Discover the Silk Road</p>
                </div>
              </div>
              <div className="absolute top-6 right-6 w-16 h-16 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <Star className="w-8 h-8 text-white" />
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        ...
        <div className="container-custom">
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="heading-secondary">
              We're Well Experienced in <span className="gradient-text">File Processing</span> for:
            </h2>
            <p className="text-primary text-xl">
              Expert handling of complex visa applications for premium destinations
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            {[
              ...
              <div key={index} className={`bg-white p-8 rounded-2xl shadow-xl text-center hover:shadow-2xl transition-all duration-500 hover:scale-105 hover-glow animate-scale-in animate-delay-${(index + 1) * 100}`}>
                <div className="text-6xl mb-4 animate-float" style={{ animationDelay: `${index * 0.2}s` }}>{country.flag}</div>
                <h3 className="font-bold text-[var(--color-primary6)] text-lg leading-tight">{country.name}</h3>
              </div>
            ))}
          </div>
      ...
      <section className="section-padding bg-gradient-to-br from-white via-[var(--color-primary1)]/5 to-white">
        <div className="container-custom">
          <div className="max-w-5xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in-up animate-delay-200">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <label htmlFor="name" className="block text-lg font-bold text-[var(--color-primary6)] mb-3">
                    Full Name *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-lg font-bold text-[var(--color-primary6)] mb-3">
                    Email Address *
                  </label>
                  <input
                    type="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <label htmlFor="phone" className="block text-lg font-bold text-[var(--color-primary6)] mb-3">
                    Phone Number *
                  </label>
                  <input
                    type="tel"
                ...
                <div>
                  <label htmlFor="country" className="block text-lg font-bold text-[var(--color-primary6)] mb-3">
                    Select Country *
                  </label>
                  <select
                    id="country"
              ...
              <div>
                <label htmlFor="message" className="block text-lg font-bold text-[var(--color-primary6)] mb-3">
                  Message *
                </label>
                <textarea
                  id="message"
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 via-white to-gray-50">
        <div className="container-custom">
          ...
          <div className="rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-shadow duration-500 animate-scale-in animate-delay-200">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3620.2097459609327!2d67.0099!3d24.8607!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33e06651d4bbf%3A0x9cf92f44555a0c23!2sKarachi%2C%20Pakistan!5e0!3m2!1sen!2s!4v1648995940000!5m2!1sen!2s"
              width="100%"
              height="500"
              style={{ border: 0 }}
              allowFullScreen
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="text-center p-8 bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 hover-glow animate-fade-in-up animate-delay-300">
              ...
              <h3 className="font-bold text-[var(--color-primary6)] mb-3 text-xl">Address</h3>
              <p className="text-gray-600 text-lg">123 Travel Street, Karachi, Pakistan</p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 hover-glow animate-fade-in-up animate-delay-400">
              ...
              <h3 className="font-bold text-[var(--color-primary6)] mb-3 text-xl">Phone</h3>
              <p className="text-gray-600 text-lg">+92 21 1234567</p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 hover-glow animate-fade-in-up animate-delay-500">
              ...
              <h3 className="font-bold text-[var(--color-primary6)] mb-3 text-xl">Hours</h3>
              <p className="text-gray-600 text-lg">Mon-Fri: 9AM-6PM</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 animate-fade-in-up">
            <div className="animate-fade-in-left">
              <h3 className="text-3xl font-black mb-6 gradient-text">Travel Agency</h3>
              <p className="text-gray-300 mb-6 text-lg leading-relaxed">
                Your trusted partner for visa processing and travel services worldwide.
              </p>
              <div className="flex space-x-6">
                <div className="w-12 h-12 bg-gradient-to-br from-[var(--color-primary4)] to-[var(--color-primary7)] rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 cursor-pointer hover-glow">
                  <span className="text-[var(--color-primary6)] font-bold text-lg">f</span>
                </div>
                <div className="w-12 h-12 bg-gradient-to-br from-[var(--color-primary4)] to-[var(--color-primary7)] rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 cursor-pointer hover-glow">
                  <span className="text-[var(--color-primary6)] font-bold text-lg">t</span>
                </div>
                <div className="w-12 h-12 bg-gradient-to-br from-[var(--color-primary4)] to-[var(--color-primary7)] rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 cursor-pointer hover-glow">
                  <span className="text-[var(--color-primary6)] font-bold text-lg">i</span>
                </div>
              </div>
            </div>
            
            <div className="animate-fade-in-up animate-delay-200">
              <h4 className="text-xl font-bold mb-6 text-[var(--color-primary1)]">Quick Links</h4>
              <ul className="space-y-4 text-gray-300">
                <li><a href="#" className="hover:text-[var(--color-primary1)] transition-all duration-300 text-lg hover:translate-x-2 inline-block">About Us</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary1)] transition-all duration-300 text-lg hover:translate-x-2 inline-block">Services</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary1)] transition-all duration-300 text-lg hover:translate-x-2 inline-block">Visa Process</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary1)] transition-all duration-300 text-lg hover:translate-x-2 inline-block">Contact</a></li>
              </ul>
            </div>
            
            <div className="animate-fade-in-up animate-delay-300">
              <h4 className="text-xl font-bold mb-6 text-[var(--color-primary1)]">Services</h4>
              <ul className="space-y-4 text-gray-300">
                <li><a href="#" className="hover:text-[var(--color-primary1)] transition-all duration-300 text-lg hover:translate-x-2 inline-block">Visa Processing</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary1)] transition-all duration-300 text-lg hover:translate-x-2 inline-block">Travel Insurance</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary1)] transition-all duration-300 text-lg hover:translate-x-2 inline-block">Hotel Booking</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary1)] transition-all duration-300 text-lg hover:translate-x-2 inline-block">Flight Tickets</a></li>
              </ul>
            </div>
            
            <div className="animate-fade-in-right animate-delay-400">
              <h4 className="text-xl font-bold mb-6 text-[var(--color-primary1)]">Contact Info</h4>
          ...
          <div className="border-t border-gray-700 mt-16 pt-12 text-center text-gray-300 animate-fade-in-up animate-delay-600">
            <p className="text-lg">&copy; 2024 Travel Agency. All rights reserved. | Privacy Policy | Terms of Service</p>
          </div>
        </div>
      </footer>
    </main>
